...
from flask_cors import CORS                          # Para habilitar CORS en la app

app = Flask(__name__)

CORS(app, resources={r"/*":{"/origins": "http://localhost:3000"}}, supports_credentials=True) # habilitar CORS en la app
